            ...
            <div>
              ...
              <form @submit.prevent="submitForm" class="space-y-6">
                ...
                <button
                  ...
                  class="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white px-8 py-3 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center gap-2"
                >
              ...
              <div class="space-y-6">
                ...
                <div class="bg-indigo-50 rounded-xl p-6">
                  ...
                  <div class="flex space-x-4">
                    <a href="#" class="w-10 h-10 bg-blue-600 hover:bg-blue-700 text-white rounded-full flex items-center justify-center transition-colors">
